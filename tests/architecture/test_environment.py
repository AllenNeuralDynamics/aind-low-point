...
ENV_READ_BASELINE = {
    ...
    "aind_rutter.optimization.pipeline.enumeration:CONFIG@import",
    "aind_rutter.optimization.pipeline.enumeration:HOLES@import",
    ...
    "aind_rutter.optimization.pipeline.phase1_pool:COV_ALPHA@import",
    "aind_rutter.optimization.pipeline.phase1_pool:COV_NORM@import",
    "aind_rutter.optimization.pipeline.phase1_pool:COV_WEIGHT@import",
    ...
    "aind_rutter.optimization.pipeline.phase1_pool:WELL@import",
    ...
    "aind_rutter.optimization.pipeline.restore:CONFIG@import",
    "aind_rutter.optimization.pipeline.restore:HOLES@import",
