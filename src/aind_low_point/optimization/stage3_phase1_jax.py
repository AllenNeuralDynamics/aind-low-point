...
def _build_jit(
    ...
    def _objective(
        ...
        # Dual-rep clearance: three categories per pair, soft-min top-k,
        # ReLU-squared penalty summed. Also collect per-pair hard mins
        # to feed the saturating margin reward.
