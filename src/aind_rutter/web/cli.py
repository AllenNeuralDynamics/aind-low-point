...
Installed as the ``rutter-plan`` console script. Loads a full ``ConfigModel``
...
Open a config::
    ...
    rutter-plan examples/836656-config-T12.yml
...
@dataclass
class Args:
    """Command-line arguments for the ``rutter-plan`` launcher."""
