...
| D7 | `.npy` sources name a loader that does not exist (fixed) | `config.py:43` infers `numpy_points`; no loader registers that name | Any `.npy` source fails at build | verified |
