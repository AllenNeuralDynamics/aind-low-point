...
| D11 | The optimizer ignores a configured probe pivot (fixed) | Nothing under `optimization/` reads `pivot_LPS`; the app honors it (`planning.py:405`) | Latent: every current config leaves it null | verified |
